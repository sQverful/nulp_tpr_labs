...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String[] EMVs = TreeDecision.getEMV(input);
         ...
         */
        String[][] table = new String[][] { { "A", "B", "C", "D", "E", "F", "Solution" },
                { EMVs[0], EMVs[1], EMVs[2], EMVs[3], EMVs[4], EMVs[5], TreeDecision.findDecision(input)}};
